...
namespace PL.BuggySoft.Infrastructure.Tests
{
	...
	public class BuggyMessageWrapperTests
	{
		...
		{
			// Arrange
			var rawData = new byte[] { 0x05, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
		...
		{
			// Arrange
			var rawData = new byte[] { 0x06, 0x00, 0x01, 0x07, 0x01, 0x02, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
		...
		public void ResetBuggyMessage_FromBuffer_CorrectString()
		{
			// Arrange
			var unitUnderTest = new ResetDoneMessageWrapper(new byte[]
					{0x0A, 0x15, 0x00, 0x02, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00});
